...
public class EssayReview {
	...
	@CollectionTable(name = "essay_review_strong_evidence", joinColumns = @JoinColumn(name = "essay_review_id"))
	@Column(name = "line_text", columnDefinition = "text")
	private List<String> strongEvidences = new ArrayList<>();

	@ElementCollection(fetch = FetchType.LAZY)
	@CollectionTable(name = "essay_review_strong_evidence_reasons", joinColumns = @JoinColumn(name = "essay_review_id"))
	@Column(name = "reason_text", columnDefinition = "text")
	private List<String> strongEvidenceReasons = new ArrayList<>();

	@ElementCollection(fetch = FetchType.LAZY)
	@CollectionTable(name = "essay_review_weak_phrases", joinColumns = @JoinColumn(name = "essay_review_id"))
	@Column(name = "line_text", columnDefinition = "text")
	private List<String> weakEvidences = new ArrayList<>();

	@ElementCollection(fetch = FetchType.LAZY)
	@CollectionTable(name = "essay_review_weak_phrases_reasons", joinColumns = @JoinColumn(name = "essay_review_id"))
	@Column(name = "reason_text", columnDefinition = "text")
	private List<String> weakEvidenceReasons = new ArrayList<>();

	@ElementCollection(fetch = FetchType.LAZY)
	@CollectionTable(name = "essay_review_keywords", joinColumns = @JoinColumn(name = "essay_review_id"))
